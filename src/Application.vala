/*
 * Copyright 2011-2023 Phyre Ltd. (https://phyreos.io)
...
public class Terminal.Application : Gtk.Application {
    ...
    public Application () {
        Object (
            application_id: "io.phyre.terminal", /* Ensures only one instance runs */
    ...
    protected override void startup () {
        ...
        saved_state = new GLib.Settings ("io.phyre.terminal.saved-state");
        settings = new GLib.Settings ("io.phyre.terminal.settings");
